$(function() {
    ...
    $(document).ready(function () {
        $("#type-success").on("click", function () {
            toastr.success("Form is submitted!", "RootsLink says");
        }),
        ...
        $("#fade-toast").on("click", function () {
            toastr.success("I do not think that word means what you think it means.", "Slide Down / Slide Up!", { showMethod: "fadeIn", hideMethod: "fadeOut", timeOut: 2e3 });
        });
    });
});
